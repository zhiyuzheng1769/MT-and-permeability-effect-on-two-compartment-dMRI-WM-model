...
function main()
    ...
    geom = MCMRSimulator.read_geometry("distributed_cylinders_samevar/MT/cylinders_MT_"*@sprintf("%d",mt)*"_sus_0_perm_0.000_rmean_"*@sprintf("%.2f",radius)*"_density_0.65.json")
